...
var mdp= $("#mdp");
  ...
  btnAdd.on("click", function(event) {
    ...
    loadingElement.classList.remove('d-none'); // Afficher l'animation de chargement
    ...
    return new Promise(function(resolve, reject) {
      ...
      navigator.serviceWorker.ready
        .then(function(registration) {
          // Vérifier si le service worker est enregistré et activé
          ...
          // Attendre la réponse du service worker
          navigator.serviceWorker.addEventListener('message', function(event) {
            var result = event.data;
            loadingElement.classList.add('d-none'); // Masquer l'animation de chargement
